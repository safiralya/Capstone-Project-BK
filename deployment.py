...
# menulis biasa, di mana font-nya akan lebih kecil dari header dan **...** digunakan agar tulisan menjadi bold
st.write(f"**_Model's Accuracy_** :  :green[**{accuracy}**]% (:red[_Do not copy outright_])")
st.write("")

# membuat dua tab terpisah dalam satu halaman yang sama
tab1, tab2 = st.tabs(["Single-predict", "Multi-predict"])

with tab1:
  # membuat sidebar input
